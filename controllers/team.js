module.exports = function (app) {
  ...
  // GET: /team/mission/:num
  app.get('/team/mission/:num/play', /* ensureAuthenticated, */ function (req, res) {
  ...
  app.post('/team/mission/:num/play', /* ensureAuthenticated, */ function (req, res) {
  ...
  app.get('/team/mission/:num/completed', /* ensureAuthenticated, */ function (req, res) {
  ...
  app.get('/team/mission/:num/failed', /* ensureAuthenticated, */ function (req, res) {
  ...
  // GET: /team/mission/:num/failed
  app.get('/team/mission/:num/waiting', /* ensureAuthenticated, */ function (req, res) {
    res.render('team/waiting', {
