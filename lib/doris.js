...
Doris.getTeamByUserId = function (userId, callback) {
  if (typeof userId === 'string' && typeof callback === 'function') {
    this.findUser(userId, function (err, user) {
      if (!err) {
        Doris.Team.findById(user.teamId, function (err, team) {
  ...
  if (typeof teamId === 'string' && typeof callback === 'function') {
    this.Team.findById(teamId, function (err, team) {
      if (team.lastMission === '') {
        ...
        if (team.lastTask !== '' && team.lastTask !== 'undefined') {
    ...
    this.Team.findById(teamId, function (err, team) {
      if (completed) {
        Doris.tasks(function (err, tasks) {
          ...
          if (typeof tasks[_i] !== 'undefined') {
            callback(err, tasks[_i]);
          } else {
            callback(err, tasks[0]);
          }
        });
...
Doris.addMission = function (taskId, userId, callback) {
  if (typeof taskId === 'string' && typeof userId === 'string' && typeof callback === 'function') {
    this.findUser(userId, function (err, user) {
      if (!err && user) {
        Doris.Task.findById(taskId, function (err, task) {
          if (!err && task) {
            new Doris.Mission({
              ...
              completed: false,
              points: task.points,
              bounsPoints: typeof task.bounsPoints !== 'undefined' ? task.bounsPoints : 0
            }).save(callback);
          }
        });
      }
