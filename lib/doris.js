...
/**
 * Save the completed task for the user.
 *
 * @param {String} userId
 * @param {String} teamId
 * @param {String} taskId
...
Doris.completeMission = function (userId, teamId, taskId, callback) {
  if (typeof userId === 'string' && typeof teamId === 'string' && typeof taskId === 'string' && typeof callback === 'function') {
